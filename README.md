...
Визначається по вузьких очах, малій відстані від очей до брів і більш широко відкритому роту, ніж раніше.

| Режим | Умова |
|---|---|
| Абсолютний | `EAR < 0.26` та `brow_dist < 0.118` та `0.10 < MAR < 0.50` |
| Дельта | `d_ear < -0.03` та `d_brow < -0.012` та `0.08 < d_mar < 0.35` |
